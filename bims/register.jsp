...
<script>
	...
	function Validate() {
		...
		if (username.value == "" || username.value.length < 3 || username.value.length > 15) {
			...
			name_error.textContent = "Username is required. And must be at least 3 characters and less than 30 characters.";
			username.focus();
			return false;
		}
		/* validate username
		...
		if (username.value.length > 15) {
			...
			// validate fullname
		if (fullname.value == "" || fullname.value.length < 8 || fullname.value.length > 30) {
			fullname.style.border = "1px solid red";
			document.getElementById('fullname_div').style.color = "black";
			fullname_error.textContent = "Full Name is required. And mus be at least 8 characters and less than 30 characters.";
			fullname.focus();
			return false;
		}
		/* validate fullname
		if (fullname.value.length < 8) {
			fullname.style.border = "1px solid red";
			document.getElementById('fullname_div').style.color = "black";
			fullname_error.textContent = "Full name must be at least 8 characters";
			fullname.focus();
			return false;
		}
			// validate fullname
		...
		// validate phone
		if (phone.value == "" || phone.value.length < 10 || phone.value.length > 30) {
			phone.style.border = "1px solid red";
			document.getElementById('phone_div').style.color = "black";
			phone_error.textContent = "Phone no. is required. And mus be at least 8 characters and less than 30 characters.";
			phone.focus();
			return false;
		}
		/* validate phone
		...
		if (address.value.length > 30 || address.value == "" || address.value.length < 5 ) {
			address.style.border = "1px solid red";
			document.getElementById('address_div').style.color = "black";
			address_error.textContent = "Address is required. And must be more than 5 characters and less than 30 characters.";
			address.focus();
			return false;
		}
	}
